...
const Footer = () => {
  return (
    ...
    <section className="flex bg-no-repeat bg-cover max-w-full py-20 bg-[url('/hands.jpg')] bg-center bg-blend-multiply">
    <div className="mx-auto max-w-screen-xl px-4 py-2 text-center lg:py-5">
